...
const Sidebar = () => {
 ...
 return showSidebar ? (
    <div className="fixed left-0  top-16 min-h-screen w-56 pt-4">
      ...
      <div className="my-5">
        ...
        <div className="flex w-fit item-center border-2  rounded-full py-[6px] px-3  cursor-pointer ml-6 my-3 bg-green-300">
          <FaRegUserCircle className="text-neutral-600 text-xl" />
          <p className="text-blue-600 text-sm font-semibold  ml-2">Sign In</p>
        </div>
      </div>
      <hr className="border-gray-700 my-4" />
    </div>
  ) : (
    <div className="fixed left-0 top-16  min-h-screen w-fit pt-4 flex flex-col  ">
        <div >
